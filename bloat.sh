...
echo '  <project name="omnirom/android_kernel_oneplus_sm8150" path="kernel/oneplus/sm8150" remote="github" revision="android-10" />' >> ./.repo/local_manifests/potato_manifest.xml
