...
echo '  <project name="killcmd/device_oneplus_guacamole" path="device/oneplus/guacamole" remote="github" revision="croquette-release" />' >> ./.repo/local_manifests/AEX_manifest.xml
...
echo '  <project name="killcmd/device_oneplus_sm8150-common" path="device/oneplus/sm8150-common" remote="github" revision="AEX" />' >> ./.repo/local_manifests/AEX_manifest.xml
